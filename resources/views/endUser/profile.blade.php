                ...
                <div class="order-history">
                    <div class="profile">
                        ...
                        <div class="order-his-page">
                            <ul class="profile-ul">
                                <li class="profile-li"><a href="{{route('cart.orders')}}"><span>Orders</span> <span class="pro-count">{{(count($orders)) ? count($orders) : ' '}}</span></a></li>
                                <li class="profile-li"><a href="{{route('user.profile')}}" class="active">Profile</a></li>
                                <li class="profile-li"><a href="{{route('user.address.index')}}">Address</a></li>
                                <li class="profile-li"><a href="{{route('wishlist.index',['en'])}}"><span>Wishlist</span> <span class="pro-count">3</span></a></li>
                            </ul>
                        </div>
                    </div>
