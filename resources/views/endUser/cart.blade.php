                                ...
                                <div class="cart-all-pro">
                                    <div class="cart-pro">
                                        <div class="cart-pro-image">
                                            <a href="product.html"><img src="{{asset('storage/images/'.$cart->detail['image'])}}" class="img-fluid" alt="image"></a>
                                        </div>
                                        <div class="pro-details">
                                            <h4><a href="product.html">{{$cart->detail['name']}}</a></h4>
                                            <span class="pro-size"><span class="size">Size:</span> {{$cart->detail['size']}}</span>
                                            <span class="pro-shop">color: {{$cart->detail['color']}}</span>
                                            <span class="cart-pro-price">{{$cart->detail['price']}}EGP</span>
                                        </div>
                                    </div>
                                    <div class="qty-item">
                                        <div class="center">
                                        ...
                                        @csrf
                                        @method('DELETE')
                                            <button type="submit" class="pro-remove">Remove</button>
                                            </form>
                                        </div>
                                    </div>
                                    <div class="all-pro-price">
                                        <span>{{$cart->detail['price'] * $cart->count}} EGP</span>
                                    </div>
                                </div>
                                <hr>
                                @endforeach
                            ...
                            <div class="cart-details">
                                ...
                                <div class="other-link">
                                    <ul class="c-link">
                                        ...
                                        <li class="cart-other-link"><a href="grid-list.html">Continue shopping</a></li>
                    ...
                    <div class="col-xl-3 col-xs-12 col-sm-12 col-md-12 col-lg-4">
                        <div class="cart-total">
                            <div class="cart-price">
                                <span>Subtotal</span>
                                <span class="total">{{$subTotal}} EGP</span>
                            </div>
                            <div class="cart-info">
                                <h4>Shipping info</h4>
                                <form>
                            ...
                            <div class="shop-total">
                                <span>Total</span>
                                <span class="total-amount">{{$subTotal}} EGP</span>
                            </div>
                            <form method="post" action="{{route('cart.checkout')}}">
                                @csrf
                                <button class="btn  btn-primary check-link">Checkout</button>
{{--                                <a href="checkout-1.html" class="check-link">Checkout</a>--}}
                            </form>
                        </div>
                    </div>
                </div>
