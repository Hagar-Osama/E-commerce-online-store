                        ...
                        <div class="header-element right-block-box">
                            <ul class="shop-element">
                                ...
                                <li class="side-wrap user-wrap">
                                    <div class="acc-desk">
                                        <div class="user-icon">
                                            <a href="{{route('user.profile')}}" class="user-icon-desk">
                                        ...
                                        <div class="user-info">
                                            ...
                                            <div class="account-login">
                                                ...
                                                <form action="{{route('user.logout')}}" method="POST">
                                                    @csrf
                                                    <input type="submit" class="btn btn-style1 ms-3" value="logout">
                                                </form>
                                            </div>
                                            @endauth
                                            @guest
                                            <div class="account-login">
                                                <a href="{{route('user.registerPage',['en'])}}">Register</a>
                                                <a href="{{route('user.loginPage',['en'])}}">Log in</a>
                                            </div>
                                            @endguest
                                        ...
                                        <div class="mainwrap">
                                            <ul class="main-menu">
                                                <li class="menu-link parent">
                                                    <a href="{{route('home',['en'])}}" class="link-title">
    ...
    <div class="mini-cart">
        ...
        <div class="cart-item-title">
            <p>
                ...
                <span class="cart-count-item bigcounter"></span>
                ...
                <div class="cart-title">
                    ...
                    <div class="cart-pro-info">
                        ...
                        <form action="{{route('cart.delete',[$cart->id])}}">
                                @csrf
                                @method('DELETE')
                            <button><i class="icon-trash icons"></i></button>
                            </form>
                        </div>
                    </div>
                </div>
        ...
        <ul class="subtotal-title-area">
            ...
            <li class="mini-cart-btns">
                <div class="cart-btns">
                    <a href="{{route('cart.index',['en'])}}" class="btn btn-style2">View cart</a>
