...
{{--            </li>--}}
            ...
            <li class="menu menu-heading">
                <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg><span>Categories && Products</span></div>
            </li>
            <!-- Categories -->
            <li class="menu">
            ...
            <!-- SubCategories -->
            <li class="menu">
                <a href="#sub_category" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-box"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
                ...
                <ul class="collapse submenu list-unstyled" id="sub_category" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('sub_categories.index')}}"> Show All SubCategories </a>
                    </li>
                    <li>
                        <a href="{{route('sub_categories.create')}}"> Create New SubCategory </a>
                    </li>
                </ul>
            </li>
            <!-- Products -->
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="elements" data-parent="#accordionExample">
                    ...
                    <li>
                        <a href="{{route('products.uploadPage')}}"> Upload Products </a>
                    </li>
                    <li>
                        <a href="{{route('products.updatePage')}}"> Update Upload Products </a>
                    </li>
                </ul>
            </li>
            <!-- ProductDetails -->
            <li class="menu">
                <a href="#product_details" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-box"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
                ...
                <ul class="collapse submenu list-unstyled" id="product_details" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('product.details.index')}}"> Show All ProductDetails </a>
                    </li>
                    <li>
                        <a href="{{route('product.details.create')}}"> Create New ProductDetails </a>
                    </li>
                </ul>
            </li>
            <!-- SizeUnit -->
            <li class="menu">
                <a href="#size_units" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-zap"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>
                        <span>SizeUnits</span>
                    </div>
                ...
                <ul class="collapse submenu list-unstyled" id="size_units" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('size-unit.index')}}"> Show All SizeUnit </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled" id="size_units" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('size-unit.create')}}"> Create New SizeUnit </a>
                    </li>
                </ul>
            </li>
            <!-- Sizes -->
            <li class="menu">
                <a href="#sizes" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-zap"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>
                        <span>Sizes</span>
                    </div>
                ...
                <ul class="collapse submenu list-unstyled" id="sizes" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('sizes.index')}}"> Show All Size </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled" id="sizes" data-parent="#accordionExample">
                    <li>
            ...
            <!-- Colors -->
            <li class="menu">
                <a href="#colors" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-zap"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>
                        <span>Colors</span>
                    </div>
                ...
                <ul class="collapse submenu list-unstyled" id="colors" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('colors.index')}}"> Show All Colors </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled" id="colors" data-parent="#accordionExample">
                    <li>
            ...
            <li class="menu">
                <a href="#cat_policy" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-zap"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>
                        <span>CategoryPolicies</span>
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                    </div>
                </a>
                <ul class="collapse submenu list-unstyled" id="cat_policy" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('categoryPolicy.index')}}"> Show All CategoryPolicies </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled" id="cat_policy" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('categoryPolicy.create')}}"> Create New CategoryPolicies </a>
                    </li>
                </ul>
            </li>
            <!-- Policies -->
            ...
            <li class="menu">
                <a href="#policy" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-zap"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>
                        <span>Policies</span>
                    </div>
                ...
                <ul class="collapse submenu list-unstyled" id="policy" data-parent="#accordionExample">
                    <li>
                        <a href="{{route('policy.index')}}"> Show All Policies </a>
                    </li>
                </ul>
                <ul class="collapse submenu list-unstyled" id="policy" data-parent="#accordionExample">
                    <li>
